...
[![Unit Tests](https://img.shields.io/badge/unit_tests-313-4c9f70?logo=nodedotjs&logoColor=white)](#tests-ausf%C3%BChren)
[![Lines of Code](https://img.shields.io/badge/lines_of_code-6281-8a7bd8?logo=javascript&logoColor=000)](#tech-stack)
[![Coverage (Unit)](https://img.shields.io/badge/coverage_(unit)-95.76%25_lines-brightgreen)](#tests-ausf%C3%BChren)
...
```bash
npm test                                                        # 313 Unit-Tests, Nodes eingebauter Runner, null Test-Dependencies
...
Getestet wird die **abhängigkeitsfreie Pure-Logik** — Stand heute **313 Tests, 100 % Line-Coverage**
