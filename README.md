...
```bash
npm test                                                        # 149 Unit-Tests, Nodes eingebauter Runner, null Test-Dependencies
...
Getestet wird die **abhängigkeitsfreie Pure-Logik** — Stand heute **149 Tests, 100 % Line-Coverage**
