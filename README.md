...
[![Unit Tests](https://img.shields.io/badge/unit_tests-314-4c9f70?logo=nodedotjs&logoColor=white)](#tests-ausf%C3%BChren)
[![Lines of Code](https://img.shields.io/badge/lines_of_code-6360-8a7bd8?logo=javascript&logoColor=000)](#tech-stack)
[![Coverage (Unit)](https://img.shields.io/badge/coverage_(unit)-95.78%25_lines-brightgreen)](#tests-ausf%C3%BChren)
...
```bash
npm test                                                        # 314 Unit-Tests, Nodes eingebauter Runner, null Test-Dependencies
...
Getestet wird die **abhängigkeitsfreie Pure-Logik** — Stand heute **314 Tests, 100 % Line-Coverage**
