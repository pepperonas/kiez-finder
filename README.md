...
[![Unit Tests](https://img.shields.io/badge/unit_tests-247-4c9f70?logo=nodedotjs&logoColor=white)](#tests-ausf%C3%BChren)
...
```bash
npm test                                                        # 247 Unit-Tests, Nodes eingebauter Runner, null Test-Dependencies
...
Getestet wird die **abhängigkeitsfreie Pure-Logik** — Stand heute **247 Tests, 100 % Line-Coverage**
