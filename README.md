...
[![Unit Tests](https://img.shields.io/badge/unit_tests-293-4c9f70?logo=nodedotjs&logoColor=white)](#tests-ausf%C3%BChren)
[![Lines of Code](https://img.shields.io/badge/lines_of_code-6020-8a7bd8?logo=javascript&logoColor=000)](#tech-stack)
[![Coverage (Unit)](https://img.shields.io/badge/coverage_(unit)-95.50%25_lines-brightgreen)](#tests-ausf%C3%BChren)
...
```bash
npm test                                                        # 293 Unit-Tests, Nodes eingebauter Runner, null Test-Dependencies
...
Getestet wird die **abhängigkeitsfreie Pure-Logik** — Stand heute **293 Tests, 100 % Line-Coverage**
...
Logik wird stattdessen in maplibre-freie Module extrahiert (`prefs.js`, `overlayLabels.js`). Die CI
