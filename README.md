...
- 🗺️ **Sektoren-Overlay** (4-Stufen-Button) — *aus · Bezirke (L) · Regionen (M) · Kieze (S)*, von grob nach fein. Färbt die jeweilige Ebene **nachbarschafts-bewusst** (Distanz-2-Graph-Coloring über geteilte Grenzen) → angrenzende **und** nahe Flächen bekommen weit auseinanderliegende Farbtöne und sind klar unterscheidbar. Eine schwebende **„Aktueller-Bereich"-Plakette** benennt mit Farbpunkt stets die Fläche in der Kartenmitte — auch tief reingezoomt, wenn das normale Label außerhalb des Bildausschnitts liegt
