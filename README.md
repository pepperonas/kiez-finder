...
[![Unit Tests](https://img.shields.io/badge/unit_tests-251-4c9f70?logo=nodedotjs&logoColor=white)](#tests-ausf%C3%BChren)
[![Lines of Code](https://img.shields.io/badge/lines_of_code-5341-8a7bd8?logo=javascript&logoColor=000)](#tech-stack)
...
```bash
npm test                                                        # 251 Unit-Tests, Nodes eingebauter Runner, null Test-Dependencies
...
Getestet wird die **abhängigkeitsfreie Pure-Logik** — Stand heute **251 Tests, 100 % Line-Coverage**
