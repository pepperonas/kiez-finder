...
[![Unit Tests](https://img.shields.io/badge/unit_tests-246-4c9f70?logo=nodedotjs&logoColor=white)](#tests-ausf%C3%BChren)
...
```bash
npm test                                                        # 246 Unit-Tests, Nodes eingebauter Runner, null Test-Dependencies
...
Getestet wird die **abhängigkeitsfreie Pure-Logik** — Stand heute **246 Tests, 100 % Line-Coverage**
