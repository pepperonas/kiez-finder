...
// satellite cities '/data/frankfurt', '/data/darmstadt', …. A city without a
// given enrichment file just gets a 404 → each loader already degrades to null
// (no Berlin data leaks in).
// ─────────────────────────────────────────────────────────────────────────
let _dir = '/data'
